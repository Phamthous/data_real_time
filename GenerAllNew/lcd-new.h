...
//sas change XTAL to F_CPU in make file
...
#if LCD_4BIT_MODE==1
#warning "4-BIT-MODE"
// mtmt changed to test-hardware //SAS GenerAll
...
#warning "8-BIT-MODE"
#define LCD_DATA_PORT    PORTB     /**< port for the LCD lines   */
...
extern unsigned char lcd_getxy(void);
...
/**
 ...
 @return   none
*/
//extern int lcd_putc(char c, FILE *stream);
